...
- Example: "Try running `npm start` with the --verbose flag."
...
Structure:
1. Setup with curiosity hook
2. Minimal context (tool + goal)
3. Reveal with emoji punctuation
4. Light caveat
5. Optional CTA
...
Fair warning: [edge case]. But for most use cases, try [specific action].
```

### Contrast Pattern

Structure:
1. Old way = friction (concrete pain)
2. New way = flow (specific solution)
3. Proof point (time saved, outcome)
4. Button emoji
